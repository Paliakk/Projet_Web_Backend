...
namespace Data.Migrations
{
    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Assignment",
                columns: new[] { "Id", "CourseId", "Title", "Description", "Deadline", "CreatedAt" },
                values: new object[,]
                {
                { 1, 1, "HTML Basics", "Introduction to HTML", DateTime.Now.AddDays(-7), DateTime.Now },
                { 2, 1, "CSS Styling", "Learn to style with CSS", DateTime.Now.AddDays(14), DateTime.Now },
                { 3, 1, "JavaScript Fundamentals", "Basic JavaScript concepts", DateTime.Now.AddDays(21), DateTime.Now },
                { 4, 2, "Java Syntax", "Learn the syntax of Java", DateTime.Now.AddDays(-7), DateTime.Now },
                { 5, 2, "OOP in Java", "Object-Oriented Programming concepts", DateTime.Now.AddDays(14), DateTime.Now },
                { 6, 2, "Java Collections", "Explore Java Collections Framework", DateTime.Now.AddDays(21), DateTime.Now },
                { 7, 3, "C# Basics", "Introduction to C#", DateTime.Now.AddDays(-7), DateTime.Now },
                { 8, 3, "LINQ", "Language Integrated Query in C#", DateTime.Now.AddDays(14), DateTime.Now },
                { 9, 3, "Async Programming", "Asynchronous programming in C#", DateTime.Now.AddDays(21), DateTime.Now },
                { 10, 4, "Arrays and Lists", "Basic data structures", DateTime.Now.AddDays(-7), DateTime.Now },
                { 11, 4, "Trees and Graphs", "Advanced data structures", DateTime.Now.AddDays(14), DateTime.Now },
                { 12, 4, "Hash Tables", "Understanding hash tables", DateTime.Now.AddDays(21), DateTime.Now },
                { 13, 5, "Sorting Algorithms", "Basic sorting techniques", DateTime.Now.AddDays(-7), DateTime.Now },
                { 14, 5, "Search Algorithms", "Introduction to searching", DateTime.Now.AddDays(14), DateTime.Now },
                { 15, 5, "Dynamic Programming", "Advanced algorithmic techniques", DateTime.Now.AddDays(21), DateTime.Now        },
                { 16, 6, "Network Basics", "Introduction to networking", DateTime.Now.AddDays(-7), DateTime.Now },
                { 17, 6, "TCP/IP Protocol", "Understanding TCP/IP", DateTime.Now.AddDays(14), DateTime.Now },
                { 18, 6, "Network Security", "Basics of network security", DateTime.Now.AddDays(21), DateTime.Now },
                { 19, 7, "OS Fundamentals", "Basic concepts of OS", DateTime.Now.AddDays(-7), DateTime.Now },
                { 20, 7, "Process Management", "Understanding processes", DateTime.Now.AddDays(14), DateTime.Now },
                { 21, 7, "Memory Management", "How OS manages memory", DateTime.Now.AddDays(21), DateTime.Now },
                { 22, 8, "SQL Basics", "Introduction to SQL", DateTime.Now.AddDays(-7), DateTime.Now },
                { 23, 8, "Normalization", "Database normalization techniques", DateTime.Now.AddDays(14), DateTime.Now },
                { 24, 8, "Indexing", "Optimizing database performance", DateTime.Now.AddDays(21), DateTime.Now },
                { 25, 1, "Build a Personal Website", "Create a personal website using HTML, CSS, and JavaScript", DateTime.Now.AddDays(30), DateTime.Now },
                { 26, 2, "Create a Java Project", "Develop a Java project using OOP principles", DateTime.Now.AddDays(30), DateTime.Now },
                { 27, 3, "C# Console Application", "Build a console application using C#", DateTime.Now.AddDays(30), DateTime.Now },
                { 28, 4, "Implement a Data Structure", "Implement and test various data structures", DateTime.Now.AddDays(30), DateTime.Now },
                { 29, 5, "Algorithm Optimization", "Optimize a given algorithm for better performance", DateTime.Now.AddDays(30), DateTime.Now },
                { 30, 6, "Network Configuration", "Configure and test a computer network", DateTime.Now.AddDays(30), DateTime.Now },
                { 31, 7, "Operating System Simulation", "Simulate an OS feature", DateTime.Now.AddDays(30), DateTime.Now },
                { 32, 8, "Database Design", "Design and implement a database system", DateTime.Now.AddDays(30), DateTime.Now }
                });
